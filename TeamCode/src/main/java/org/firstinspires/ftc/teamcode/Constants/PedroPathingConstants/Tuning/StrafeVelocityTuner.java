package org.firstinspires.ftc.teamcode.Constants.PedroPathingConstants.Tuning;
...
public class StrafeVelocityTuner extends OpMode {
    ...
    @Override
    public void init() {
        com.pedropathing.util.Constants.setConstants(
                org.firstinspires.ftc.teamcode.Constants.PedroPathingConstants.FConstants.class,
                org.firstinspires.ftc.teamcode.Constants.PedroPathingConstants.LConstants.class);

        poseUpdater = new PoseUpdater(hardwareMap);

        leftFront = hardwareMap.get(DcMotorEx.class, Constants.Ids.frontLeftId);
        leftRear = hardwareMap.get(DcMotorEx.class, Constants.Ids.backLeftId);
        rightRear = hardwareMap.get(DcMotorEx.class, Constants.Ids.backRightId);
        rightFront = hardwareMap.get(DcMotorEx.class, Constants.Ids.frontRightId);
